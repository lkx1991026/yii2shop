...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="<?=\yii\helpers\Url::to(['index/index'])?>">首页</a> > <a href="<?=\yii\helpers\Url::to(['index/show','id'=>$ggfather->id])?>"><?=$ggfather->name?></a> > <a href="<?=\yii\helpers\Url::to(['index/show','id'=>$gfather->id])?>"><?=$gfather->name?></a> > <a href="<?=\yii\helpers\Url::to(['index/show','id'=>$parent->id])?>"><?=$parent->name?></a> ><?=$model->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=substr($gallerys[0]['path'],0,4)=='http'?$gallerys[0]['path']:'http://admin.yii2shop.com'.$gallerys[0]['path']?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=substr($gallerys[0]['path'],0,4)=='http'?$gallerys[0]['path']:'http://admin.yii2shop.com'.$gallerys[0]['path']?>" alt="" style="height:350px;width:350px;"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li class="<?=$k?null:'cur'?>">
                                <a class="<?=$k?null:'zoomThumbActive'?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=substr($gallery['path'],0,4)=='http'?$gallery['path']:'http://admin.yii2shop.com'.$gallery['path']?>',largeimage: '<?=substr($gallery['path'],0,4)=='http'?$gallery['path']:'http://admin.yii2shop.com'.$gallery['path']?>'}"><img src="<?=substr($gallery['path'],0,4)=='http'?$gallery['path']:'http://admin.yii2shop.com'.$gallery['path']?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="market_price"><span>定价：</span><em>￥<?=$model->shop_price?></em></li>
                    <li class="shop_price"><span>本店价：</span> <strong>￥<?=$model->market_price?></strong> <a href="">(降价通知)</a></li>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    <div class="desc mt10">
                        ...
                        <?=str_replace('src="/upload','src="http://admin.yii2shop.com/upload',$model->intro->content)?>
                    </div>
                </div>
                <!-- 商品介绍 end -->
