...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tr data-id="<?=$v['id']?>">
            <td class="col1"><a href="<?=\yii\helpers\Url::to(['index/detail','id'=>$v['id']])?>"><img src="<?=substr($v['logo'],0,4)=='http'?$v['logo']:'http://admin.yii2shop.com'.$v['logo']?>" alt="" /></a>  <strong><a href="<?=\yii\helpers\Url::to(['index/detail','id'=>$v['id']])?>"><?=$v['name']?></a></strong></td>
            ...
            <td class="col5">￥<span class="goods_amount"><?=$v['shop_price']*$carts[$v['id']]?>.00</span></td>
            <td class="col6"><a href="javascript:;" class="changeamount">删除</a></td>
        </tr>
        <?php endforeach;?>
        </tbody>
        <tfoot>
        <tr>
            <td colspan="6">购物金额总计： <strong>￥ <span id="total"><?=$amount?>.00</span></strong></td>
        </tr>
        </tfoot>
    </table>
