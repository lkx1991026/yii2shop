...
<body>
				...
				<form action="" method="post" id="signupForm">
					<ul>
						...
						<li>
							...
							<input type="text" class="txt" value="" name="tel" id="tel" placeholder="请输入11位有效手机号码"/>
						</li>
						<li>
							<label for="">验证码：</label>
	...
	<script type="text/javascript">
		function bindPhoneNum(){
			...
			$.get('<?=\yii\helpers\Url::to(['member/sms'])?>',{telnum:telnum},function (data) {
                        console.debug(data);
            })
            ...
            $("#signupForm").validate({
                rules: {
                    username: {
                        ...
                        minlength: 2,
                        maxlength:20,
                        remote:"<?=\yii\helpers\Url::to(['member/check-name'])?>"
                    },
...
//                        required:true,
        ...
        var change_captcha = function(){
            $.getJSON(captcha_url,{refresh:1},function(data){
